...
**Important**: If Metal3 is installed via Helm (e.g., `metal3-303.0.16+up0.12.6`), configuration should be done through Helm values, not by editing ConfigMaps directly, as Helm will overwrite manual changes.
